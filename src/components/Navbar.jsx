    ...
    <nav className="bg-gray-800 text-white p-4 flex justify-between items-center">
      ...
      <ul className="flex gap-4">
        ...
        {profile ? (
          ...
          <>
            <li><Link to="/users" className="hover:text-gray-300">Usuarios</Link></li>
            <li><Link to="/login" className="hover:text-gray-300">Acceder</Link></li>
            <li><Link to="/signup" className="hover:text-gray-300">Registrarse</Link></li>
          </>
        )}
      </ul>
    </nav>
